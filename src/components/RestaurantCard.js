...
const RestaurantCard = ({ resData }) => {
  ...
  // };
  return (
    <div className="w-64 h-96 m-2 rounded-lg bg-gray-100 hover:bg-gray-200" data-testid="resCard">
      ...
      <p className="text-sm font-sans">{Array.isArray(cuisines) ? cuisines.join(", ") : ""}</p>
