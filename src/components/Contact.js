...
const Contact = () =>{
 ...
 <h2 className="text-semibold text-xl text-center m-2 p-2 text-gray-700">Feel free to contact us via 8667484880</h2>
 <form className="text-semibold text-xl text-center m-2 p-2 text-gray-700 ">
